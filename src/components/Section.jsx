...
const Section = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="hidden absolute top-0 left-5 w-0.25 h-full bg-stoke-1 pointer-events-none
                        md:block lg:left-7.5 xl:left-10"
      />

      <div
        className="hidden absolute top-0 right-5 w-0.25 h-full bg-stoke-1 pointer-events-none
